...
{
  [TestFixture]
  class CalculatorNoTransformerNoCableAc : TestBase
  {
    [Test, Sequential]
    ...
    [Test, Sequential]
    public void CalcIncidentEnergy18AC([ValueSource(typeof(CalcNoXNoCAC), "GetCalculationInputSimples")] CalculationInputSimple inputSimple, [ValueSource(typeof(CalcNoXNoCAC), "GetCalculationOutputs")] CalculationOutput output)
    {
      CalculationInput input = Container.Resolve<ICalculationInput>() as CalculationInput;
    ...
    [Test, Sequential]
    public void CalcIncidentEnergy24AC([ValueSource(typeof(CalcNoXNoCAC), "GetCalculationInputSimples")] CalculationInputSimple inputSimple, [ValueSource(typeof(CalcNoXNoCAC), "GetCalculationOutputs")] CalculationOutput output)
    {
      CalculationInput input = Container.Resolve<ICalculationInput>() as CalculationInput;
    ...
    [Test, Sequential]
    public void CalcIncidentEnergy36AC([ValueSource(typeof(CalcNoXNoCAC), "GetCalculationInputSimples")] CalculationInputSimple inputSimple, [ValueSource(typeof(CalcNoXNoCAC), "GetCalculationOutputs")] CalculationOutput output)
    {
      CalculationInput input = Container.Resolve<ICalculationInput>() as CalculationInput;
    ...
    //[Test, Sequential]
    //public void CalcMultipleSensor([ValueSource(typeof(CalcNoXNoCAC), "GetCalculationInputSimples")] CalculationInputSimple inputSimple, [ValueSource(typeof(CalcNoXNoCAC), "GetCalculationOutputs")] CalculationOutput output)
    //{
